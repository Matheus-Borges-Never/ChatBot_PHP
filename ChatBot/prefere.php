...
<body>
    ...
    <form action="resultado.php" method="POST" class="row md-12" style="margin-left: 0%;">
        <!-- 1ª Parte -->
        ...
        <div class="col-md-6" style="margin-top: 3%;">
            <div class="row justify-content-between">
                <div class="col-6" style="margin-left: 8vh;">
                <?php echo "$nome"?>, Qual opção você prefere? <br>
        ...
        <div class="col-4" style="margin-top: 3%; margin-left: 80vh;">
            <input type="text" class="form-control" placeholder="..." name="txtOpc">
        </div>
